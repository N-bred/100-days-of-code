...
def compute_victory(player_cards, computer_cards, cards, is_skipped=False):
    ...
    print(
        f"Player: {player_cards} - {player_result} | CPU: {computer_cards} - {computer_result}"
    )
...
def main():
    if __name__ == "__main__":
        ...
        while is_running:
            ...
            confirmation = input("Type y to get another card, or n to pass: ")
            ...
            result = compute_victory(
                player_cards, computer_cards, GLOBAL_CARDS, skipped
            )
